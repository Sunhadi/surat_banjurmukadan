...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{asset('sneat/logo_kebumen.png')}}"/>
    ...
    <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner">
            ...
            <div class="card">
                <div class="card-body">
                    <!-- Logo -->
                    <div class="app-brand justify-content-center align-items-center d-flex">
                            <a href="{{ route('home') }}" class="app-brand-link d-flex align-items-center">
                                <img src="{{ asset('logo_kebumen.png') }}" alt="{{ config('app.name') }}" width="75px">
                                <span class="app-brand-name ms-3">
                                    Pemdes Banjurmukadan
                                </span>
                            </a>
                    </div>
