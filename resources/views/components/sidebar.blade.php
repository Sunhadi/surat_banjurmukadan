<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <a href="{{ route('home') }}" class="app-brand-link d-flex align-items-center">
        <img src="{{ asset('logo_kebumen.png') }}" alt="{{ config('app.name') }}" width="35">
        <span class="app-brand-text app-name" style="font-size: 20px; font-weight: bold; color: #333; margin-left: 10px;">
            {{ config('app.name') }}
        </span>
    </a>
